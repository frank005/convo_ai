export const microsoftVoicesByLang = {
    ...
    "Arabic (Algeria)": [
      { "shortName": "ar-DZ-AminaNeural", "friendlyName": "Amina" },
      { "shortName": "ar-DZ-IsmaelNeural", "friendlyName": "Ismael" }
    ],
    "Arabic (Egypt)": [
    ...
    "Arabic (Lebanon)": [
      { "shortName": "ar-LB-LaylaNeural", "friendlyName": "Layla" },
      { "shortName": "ar-LB-RamiNeural", "friendlyName": "Rami" }
    ],
    "Arabic (Libya)": [
    ...
    "Arabic (Morocco)": [
      { "shortName": "ar-MA-MounaNeural", "friendlyName": "Mouna" },
      { "shortName": "ar-MA-JamalNeural", "friendlyName": "Jamal" }
    ],
    "Arabic (Oman)": [
      { "shortName": "ar-OM-AyshaNeural", "friendlyName": "Aysha" },
      { "shortName": "ar-OM-AbdullahNeural", "friendlyName": "Abdullah" }
    ],
    "Arabic (Qatar)": [
    ...
    "Arabic (Tunisia)": [
      ...
      { "shortName": "ar-TN-HediNeural", "friendlyName": "Hedi" }
    ],
    "Arabic (Yemen)": [
      { "shortName": "ar-YE-MaryamNeural", "friendlyName": "Maryam" },
    ...
    "German (Germany)": [
      ...
      { "shortName": "de-DE-ElkeNeural", "friendlyName": "Elke" },
      { "shortName": "de-DE-GiselaNeural", "friendlyName": "Gisela (child)" },
      { "shortName": "de-DE-KasperNeural", "friendlyName": "Kasper" },
      { "shortName": "de-DE-KillianNeural", "friendlyName": "Killian" },
      { "shortName": "de-DE-KlarissaNeural", "friendlyName": "Klarissa" },
      { "shortName": "de-DE-KlausNeural", "friendlyName": "Klaus" },
      { "shortName": "de-DE-LouisaNeural", "friendlyName": "Louisa" },
    ...
    "English (Australia)": [
      ...
      { "shortName": "en-AU-WilliamNeural", "friendlyName": "William" },
      { "shortName": "en-AU-AnnetteNeural", "friendlyName": "Annette" },
      { "shortName": "en-AU-CarlyNeural", "friendlyName": "Carly" },
      { "shortName": "en-AU-DarrenNeural", "friendlyName": "Darren" },
      { "shortName": "en-AU-DuncanNeural", "friendlyName": "Duncan" },
      { "shortName": "en-AU-ElsieNeural", "friendlyName": "Elsie" },
      { "shortName": "en-AU-FreyaNeural", "friendlyName": "Freya" },
      { "shortName": "en-AU-JoanneNeural", "friendlyName": "Joanne" },
      { "shortName": "en-AU-KenNeural", "friendlyName": "Ken" },
      { "shortName": "en-AU-KimNeural", "friendlyName": "Kim" },
      { "shortName": "en-AU-NeilNeural", "friendlyName": "Neil" },
      { "shortName": "en-AU-TimNeural", "friendlyName": "Tim" },
      { "shortName": "en-AU-TinaNeural", "friendlyName": "Tina" }
    ],
    "English (Canada)": [
    ...
    "English (United Kingdom)": [
      ...
      { "shortName": "en-GB-ElliotNeural", "friendlyName": "Elliot" },
      { "shortName": "en-GB-EthanNeural", "friendlyName": "Ethan" },
      { "shortName": "en-GB-HollieNeural", "friendlyName": "Hollie" },
      { "shortName": "en-GB-MaisieNeural", "friendlyName": "Maisie (child)" },
      { "shortName": "en-GB-NoahNeural", "friendlyName": "Noah" },
      { "shortName": "en-GB-OliverNeural", "friendlyName": "Oliver" },
      { "shortName": "en-GB-OliviaNeural", "friendlyName": "Olivia" },
      { "shortName": "en-GB-ThomasNeural", "friendlyName": "Thomas" }
    ],
    "English (Hong Kong SAR)": [
      { "shortName": "en-HK-YanNeural", "friendlyName": "Yan" },
    ...
    "English (India)": [
      { "shortName": "en-IN-AaravNeural", "friendlyName": "Aarav" },
      { "shortName": "en-IN-AashiNeural", "friendlyName": "Aashi" },
      { "shortName": "en-IN-AnanyaNeural", "friendlyName": "Ananya" },
      { "shortName": "en-IN-KavyaNeural", "friendlyName": "Kavya" },
      { "shortName": "en-IN-KunalNeural", "friendlyName": "Kunal" },
    ...
    "English (United States)": [
      ...
      { "shortName": "en-US-DavisNeural", "friendlyName": "Davis" },
      { "shortName": "en-US-JaneNeural", "friendlyName": "Jane" },
      { "shortName": "en-US-JasonNeural", "friendlyName": "Jason" },
      { "shortName": "en-US-KaiNeural", "friendlyName": "Kai" },
      { "shortName": "en-US-LunaNeural", "friendlyName": "Luna" },
    ...
    "Spanish (Argentina)": [
      ...
      { "shortName": "es-AR-TomasNeural", "friendlyName": "Tomas" }
    ],
    "Spanish (Bolivia)": [
      { "shortName": "es-BO-SofiaNeural", "friendlyName": "Sofia" },
    ...
    "Spanish (Cuba)": [
      ...
      { "shortName": "es-CU-ManuelNeural", "friendlyName": "Manuel" }
    ],
    "Spanish (Dominican Republic)": [
      { "shortName": "es-DO-RamonaNeural", "friendlyName": "Ramona" },
      { "shortName": "es-DO-EmilioNeural", "friendlyName": "Emilio" }
    ],
    "Spanish (Ecuador)": [
      { "shortName": "es-EC-AndreaNeural", "friendlyName": "Andrea" },
      { "shortName": "es-EC-LuisNeural", "friendlyName": "Luis" }
    ],
    "Spanish (Spain)": [
      ...
      { "shortName": "es-ES-EliasNeural", "friendlyName": "Elias" },
      { "shortName": "es-ES-EstrellaNeural", "friendlyName": "Estrella" },
      { "shortName": "es-ES-IreneNeural", "friendlyName": "Irene" },
      { "shortName": "es-ES-LaiaNeural", "friendlyName": "Laia" },
      { "shortName": "es-ES-LiaNeural", "friendlyName": "Lia" },
      { "shortName": "es-ES-NilNeural", "friendlyName": "Nil" },
      { "shortName": "es-ES-SaulNeural", "friendlyName": "Saul" },
      { "shortName": "es-ES-TeoNeural", "friendlyName": "Teo" },
    ...
    "Spanish (Equatorial Guinea)": [
      ...
      { "shortName": "es-GQ-JavierNeural", "friendlyName": "Javier" }
    ],
    "Spanish (Guatemala)": [
      { "shortName": "es-GT-MartaNeural", "friendlyName": "Marta" },
      { "shortName": "es-GT-AndresNeural", "friendlyName": "Andres" }
    ],
    "Spanish (Honduras)": [
      { "shortName": "es-HN-KarlaNeural", "friendlyName": "Karla" },
      { "shortName": "es-HN-CarlosNeural", "friendlyName": "Carlos" }
    ],
    "Spanish (Mexico)": [
      { "shortName": "es-MX-DaliaNeural", "friendlyName": "Dalia" },
      { "shortName": "es-MX-JorgeNeural", "friendlyName": "Jorge" },
      { "shortName": "es-MX-BeatrizNeural", "friendlyName": "Beatriz" },
      { "shortName": "es-MX-CandelaNeural", "friendlyName": "Candela" },
      { "shortName": "es-MX-CarlotaNeural", "friendlyName": "Carlota" },
      { "shortName": "es-MX-CecilioNeural", "friendlyName": "Cecilio" },
      { "shortName": "es-MX-GerardoNeural", "friendlyName": "Gerardo" },
      { "shortName": "es-MX-LarissaNeural", "friendlyName": "Larissa" },
      { "shortName": "es-MX-LibertoNeural", "friendlyName": "Liberto" },
      { "shortName": "es-MX-LucianoNeural", "friendlyName": "Luciano" },
      { "shortName": "es-MX-MarinaNeural", "friendlyName": "Marina" },
      { "shortName": "es-MX-NuriaNeural", "friendlyName": "Nuria" },
      { "shortName": "es-MX-PelayoNeural", "friendlyName": "Pelayo" },
      { "shortName": "es-MX-RenataNeural", "friendlyName": "Renata" },
      { "shortName": "es-MX-YagoNeural", "friendlyName": "Yago" }
    ],
    "Spanish (Nicaragua)": [
      { "shortName": "es-NI-YolandaNeural", "friendlyName": "Yolanda" },
      { "shortName": "es-NI-FedericoNeural", "friendlyName": "Federico" }
    ],
    "Spanish (Panama)": [
      { "shortName": "es-PA-MargaritaNeural", "friendlyName": "Margarita" },
      { "shortName": "es-PA-RobertoNeural", "friendlyName": "Roberto" }
    ],
    "Spanish (Peru)": [
    ...
    "Spanish (Puerto Rico)": [
      ...
      { "shortName": "es-PR-VictorNeural", "friendlyName": "Victor" }
    ],
    "Spanish (Paraguay)": [
      { "shortName": "es-PY-TaniaNeural", "friendlyName": "Tania" },
      { "shortName": "es-PY-MarioNeural", "friendlyName": "Mario" }
    ],
    "Spanish (El Salvador)": [
      { "shortName": "es-SV-LorenaNeural", "friendlyName": "Lorena" },
      { "shortName": "es-SV-RodrigoNeural", "friendlyName": "Rodrigo" }
    ],
    ...
    "Spanish (Uruguay)": [
      { "shortName": "es-UY-ValentinaNeural", "friendlyName": "Valentina" },
    ...
    "French (Canada)": [
      ...
      { "shortName": "fr-CA-JeanNeural", "friendlyName": "Jean" },
      { "shortName": "fr-CA-AntoineNeural", "friendlyName": "Antoine" },
      { "shortName": "fr-CA-ThierryNeural", "friendlyName": "Thierry" }
    ],
    "French (Switzerland)": [
    ...
    "French (France)": [
      ...
      { "shortName": "fr-FR-ClaudeNeural", "friendlyName": "Claude" },
      { "shortName": "fr-FR-CoralieNeural", "friendlyName": "Coralie" },
      { "shortName": "fr-FR-EloiseNeural", "friendlyName": "Eloise (child)" },
      { "shortName": "fr-FR-JacquelineNeural", "friendlyName": "Jacqueline" },
      { "shortName": "fr-FR-JeromeNeural", "friendlyName": "Jerome" },
      { "shortName": "fr-FR-JosephineNeural", "friendlyName": "Josephine" },
    ...
    "Hindi (India)": [
      { "shortName": "hi-IN-AaravNeural", "friendlyName": "Aarav" },
      { "shortName": "hi-IN-AnanyaNeural", "friendlyName": "Ananya" },
      { "shortName": "hi-IN-KavyaNeural", "friendlyName": "Kavya" },
      { "shortName": "hi-IN-KunalNeural", "friendlyName": "Kunal" },
    ...
    "Italian (Italy)": [
      ...
      { "shortName": "it-IT-FabiolaNeural", "friendlyName": "Fabiola" },
      { "shortName": "it-IT-FiammaNeural", "friendlyName": "Fiamma" },
      { "shortName": "it-IT-GianniNeural", "friendlyName": "Gianni" },
      { "shortName": "it-IT-GiuseppeNeural", "friendlyName": "Giuseppe" },
      { "shortName": "it-IT-ImeldaNeural", "friendlyName": "Imelda" },
      { "shortName": "it-IT-IrmaNeural", "friendlyName": "Irma" },
      { "shortName": "it-IT-LisandroNeural", "friendlyName": "Lisandro" },
      { "shortName": "it-IT-PalmiraNeural", "friendlyName": "Palmira" },
      { "shortName": "it-IT-PierinaNeural", "friendlyName": "Pierina" },
    ...
    "Japanese (Japan)": [
      ...
      { "shortName": "ja-JP-AoiNeural", "friendlyName": "Aoi" },
      { "shortName": "ja-JP-DaichiNeural", "friendlyName": "Daichi" },
    ...
    "Korean (Korea)": [
      ...
      { "shortName": "ko-KR-JiMinNeural", "friendlyName": "JiMin" },
      { "shortName": "ko-KR-SeoHyeonNeural", "friendlyName": "SeoHyeon" },
      { "shortName": "ko-KR-SoonBokNeural", "friendlyName": "SoonBok" },
    ...
    "Portuguese (Brazil)": [
      ...
      { "shortName": "pt-BR-FabioNeural", "friendlyName": "Fabio" },
      { "shortName": "pt-BR-GiovannaNeural", "friendlyName": "Giovanna" },
      { "shortName": "pt-BR-HumbertoNeural", "friendlyName": "Humberto" },
      { "shortName": "pt-BR-JulioNeural", "friendlyName": "Julio" },
      { "shortName": "pt-BR-LeilaNeural", "friendlyName": "Leila" },
      { "shortName": "pt-BR-LeticiaNeural", "friendlyName": "Leticia" },
      { "shortName": "pt-BR-ManuelaNeural", "friendlyName": "Manuela" },
      { "shortName": "pt-BR-NicolauNeural", "friendlyName": "Nicolau" },
      { "shortName": "pt-BR-ThalitaNeural", "friendlyName": "Thalita" },
      { "shortName": "pt-BR-ValerioNeural", "friendlyName": "Valerio" },
      { "shortName": "pt-BR-YaraNeural", "friendlyName": "Yara" }
    ],
    "Portuguese (Portugal)": [
    ...
    "Kiswahili (Tanzania)": [
      ...
      { "shortName": "sw-TZ-DaudiNeural", "friendlyName": "Daudi" }
    ],
    "Tamil (India)": [
    ...
    "Tamil (Sri Lanka)": [
      { "shortName": "ta-LK-SaranyaNeural", "friendlyName": "Saranya" },
      { "shortName": "ta-LK-KumarNeural", "friendlyName": "Kumar" }
    ],
    "Tamil (Malaysia)": [
      { "shortName": "ta-MY-KaniNeural", "friendlyName": "Kani" },
      { "shortName": "ta-MY-SuryaNeural", "friendlyName": "Surya" }
    ],
    "Tamil (Singapore)": [
      { "shortName": "ta-SG-VenbaNeural", "friendlyName": "Venba" },
    ...
    "Thai (Thailand)": [
      { "shortName": "th-TH-PremwadeeNeural", "friendlyName": "Premwadee" },
    ...
    "Urdu (India)": [
      { "shortName": "ur-IN-GulNeural", "friendlyName": "Gul" },
      { "shortName": "ur-IN-SalmanNeural", "friendlyName": "Salman" }
    ],
    "Urdu (Pakistan)": [
    ...
    "Chinese (Mandarin, Simplified)": [
      ...
      { "shortName": "zh-CN-XiaorouNeural", "friendlyName": "Xiaorou" },
